...
frame = Label(root, text="Accounts Book",bg="grey",fg="white",width=40,padx=20,pady=10).place(x=620, y=70)
frame1 = Frame(root, bg="lightblue", width=305, height=540)
frame1.place(x=620, y=110)
frame2 = Frame(frame1, bg="lightblue", width=305, height=510)
frame2.pack(pady=10, padx=10)
mstrs = Label(root, text="Summary",bg="lightblue",fg="black",font="17").place(x=740,y=120)

def func1():
    screen1 = Toplevel(root)
    screen1.title('create')
    screen1.geometry('1020x700') 
...
def func13():
    ...
    sbmibtn = Button(screen2, text='Bank OCC A/c',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=150)
    sbmibtn = Button(screen2, text='Bank OD A/c',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=175)
    ...
    sbmibtn = Button(screen2, text='Capital Account',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=225)
    sbmibtn = Button(screen2, text='Cash in Hand ',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=250)
    ...
    sbmibtn = Button(screen2, text='Current Liabilities',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=300)
    sbmibtn = Button(screen2, text='Deposits (Assets)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=325)
    ...
    sbmibtn = Button(screen2, text='Direct Incomes',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=375)
    sbmibtn = Button(screen2, text='Duties and Taxes',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=400)
    ...
    sbmibtn = Button(screen2, text='Expenses(Indirect)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=450)
    sbmibtn = Button(screen2, text='Fixed Assets',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=475)
    ...
    sbmibtn = Button(screen2, text='Income (Indirect)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=525)
    sbmibtn = Button(screen2, text='Indirect Expenses',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=550)
    ...
    sbmibtn = Button(screen2, text='Investments',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=600)
    sbmibtn = Button(screen2, text='Loans and Advances(Assets)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=625)
    ...
    sbmibtn = Button(screen2, text='Misc. Expenses(ASSET)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=675)
...
def func14():
    ...
    "timesnewroman", 9), activebackground="palegreen", activeforeground="red").place(x=8, y=700)  
    sbmibtn = Button(screen2, text='Primary',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=100)
    sbmibtn = Button(screen2, text='Bank Accounts',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=125)
    ...
    sbmibtn = Button(screen2, text='Bank OD A/c',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=175)
    sbmibtn = Button(screen2, text='Branch /Divisions',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=200)
    ...
    sbmibtn = Button(screen2, text='Cash in Hand ',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=250)
    sbmibtn = Button(screen2, text='Current Assets',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=275)
    ...
    sbmibtn = Button(screen2, text='Deposits (Assets)',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=325)
    sbmibtn = Button(screen2, text='Direct Expenses',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=350)
    ...
    sbmibtn = Button(screen2, text='Duties and Taxes',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=400)
    sbmibtn = Button(screen2, text='Expenses(Direct)',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=425)
    ...
    sbmibtn = Button(screen2, text='Fixed Assets',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=475)
    sbmibtn = Button(screen2, text='Income(Direct)',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=500)
    ...
    sbmibtn = Button(screen2, text='Indirect Expenses',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=550)
    sbmibtn = Button(screen2, text='Indirect Incomes',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=575)
    ...
    sbmibtn = Button(screen2, text='Loans and Advances(Assets)',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=625)
    sbmibtn = Button(screen2, text='Loans (Liability)',command=create10,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=650)
...
def func15():
    ...
    sbmibtn13 = Button(screen3, text='Cash',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=800, y=50)
...
back = Button(frame3, text="Back", width=14, fg="black", font=(
    "timesnewroman", 9), activebackground="palegreen", activeforeground="red").place(x=13, y=600)    
root.mainloop()
